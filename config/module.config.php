...
return array(
      'acl' => array(
        'Planejamento' => array(
            'PLANEJAMENTO' => array(
                'Planejamento\Controller\Index:index',              
            ),
            'TI' => array(
                'Planejamento\Controller\Index:index',              
            ),
        ...
        'routes' => array(
            ...
            'planejamento' => array(
                ...
                'options' => array(
                    'route' => '/planejamento',
                    'defaults' => array(
                       // '__NAMESPACE__' => 'Planejamento\Controller',
                        'controller' => 'Planejamento\Controller\Index',
                        'action' => 'index',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            'Planejamento\Controller\Index' => 'Planejamento\Controller\IndexController'
        ),
    ),
    'view_manager' => array(
